...
/**
 *	\file       htdocs/core/modules/propale/doc/pdf_ortazur.modules.php
 *	\ingroup    propale
 *	\brief      File of Class to generate PDF proposal with ortazur template
 */
...
/**
 *	Class to generate PDF proposal ortazur
 */
class pdf_ortazur extends ModelePDFPropales
{
	/**
	...
	public function __construct($db)
	{
		...
		$this->db = $db;
		$this->name = "ortazur";
		$this->description = "PDF Presupuestos ortazur";
